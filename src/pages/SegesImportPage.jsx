    ...
    <div className="page-stack seges-page">
      ...
      {!fileInfo ? (
        ...
        <section className="panel mapping-panel">
          ...
          <footer className="mapping-footer"><div><ShieldCheck size={18} /><p><strong>Atualização segura por matrícula</strong>Registros existentes serão atualizados, nunca duplicados.</p></div><Button variant="ghost" onClick={clearFile}>Trocar arquivo</Button><Button icon={ArrowRight} onClick={confirmImport}>Importar {fileInfo.rows.length} registros</Button></footer>
        </section>
      ) : (
